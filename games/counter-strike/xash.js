var Xash3D = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        var wasmBinaryFile;
        function findWasmBinary() { return locateFile(moduleArg.mainWasmPath); }
        ...
        var ___stack_high = 33286592;
        var ___stack_low = 16509376;
        var ___stack_pointer = new WebAssembly.Global({ value: "i32", mutable: true }, 33286592);
        ...
        var ASM_CONSTS = { 777276: () => { try {
                FS.mkdir("/rwdir");
                FS.mount(IDBFS, { root: "." }, "/rwdir");
            }
            catch (e) { } }, 777366: $0 => { var str = UTF8ToString($0) + "\n\n" + "Abort/Retry/Ignore/AlwaysIgnore? [ariA] :"; var reply = window.prompt(str, "i"); if (reply === null) {
                reply = "i";
            } return allocate(intArrayFromString(reply), "i8", ALLOC_NORMAL); }, 777591: () => { if (typeof AudioContext !== "undefined") {
                return true;
            }
            else if (typeof webkitAudioContext !== "undefined") {
                return true;
            } return false; }, 777738: () => { if (typeof navigator.mediaDevices !== "undefined" && typeof navigator.mediaDevices.getUserMedia !== "undefined") {
                return true;
            }
            else if (typeof navigator.webkitGetUserMedia !== "undefined") {
                return true;
            } return false; }, 777972: $0 => { if (typeof Module["SDL2"] === "undefined") {
                Module["SDL2"] = {};
            ...
            } return SDL2.audioContext === undefined ? -1 : 0; }, 778524: () => { var SDL2 = Module["SDL2"]; return SDL2.audioContext.sampleRate; }, 778592: ($0, $1, $2, $3) => { var SDL2 = Module["SDL2"]; var have_microphone = function (stream) { if (SDL2.capture.silenceTimer !== undefined) {
            ...
            } }, 780285: ($0, $1, $2, $3) => { var SDL2 = Module["SDL2"]; SDL2.audio.scriptProcessorNode = SDL2.audioContext["createScriptProcessor"]($1, 0, $0); SDL2.audio.scriptProcessorNode["onaudioprocess"] = function (e) { if (SDL2 === undefined || SDL2.audio === undefined) {
                return;
            ...
            } }, 781460: ($0, $1) => { var SDL2 = Module["SDL2"]; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) {
            ...
            } }, 782065: ($0, $1) => { var SDL2 = Module["SDL2"]; var buf = $0 >>> 2; var numChannels = SDL2.audio.currentOutputBuffer["numberOfChannels"]; for (var c = 0; c < numChannels; ++c) {
            ...
            } }, 782554: $0 => { var SDL2 = Module["SDL2"]; if ($0) {
            ...
            } }, 783560: ($0, $1, $2) => { var w = $0; var h = $1; var pixels = $2; if (!Module["SDL2"])
            ...
            } SDL2.ctx.putImageData(SDL2.image, 0, 0); }, 785028: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== "undefined" && data instanceof CanvasPixelArray) {
                num = data.length;
                while (dst < num) {
                    var val = HEAP32[src];
                    data[dst] = val & 255;
                ...
                num = data32.length;
                data32.set(HEAP32.subarray(src, src + num));
            } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; }, 786016: $0 => { if (Module["canvas"]) {
                Module["canvas"].style["cursor"] = UTF8ToString($0);
            } }, 786099: () => { if (Module["canvas"]) {
                Module["canvas"].style["cursor"] = "none";
            } }, 786168: () => window.innerWidth, 786198: () => window.innerHeight, 786229: ($0, $1) => { var buf = $0; var buflen = $1; var list = undefined; if (navigator.languages && navigator.languages.length) {
            ...
            } }, 786937: $0 => { window.open(UTF8ToString($0), "_blank"); }, 786977: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); }, 787034: $0 => { if (!$0) {
                AL.alcErr = 40964;
                return 1;
            } }, 787082: $0 => { if (!AL.currentCtx) {
        ...
        function stackCheckInit() { _emscripten_stack_set_limits(33286592, 16509376); writeStackCookie(); }
